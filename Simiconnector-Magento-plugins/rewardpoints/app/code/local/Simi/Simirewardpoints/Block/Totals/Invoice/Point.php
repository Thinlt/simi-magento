 ...
 */
class Simi_Simirewardpoints_Block_Totals_Invoice_Point extends Simi_Simirewardpoints_Block_Template
{
    /**
    ...
    public function initTotals()
    {
        ...
        if ($invoice->getSimirewardpointsEarn()) {
            $totalsBlock->addTotal(new Varien_Object(array(
                ...
                'value' => Mage::helper('simirewardpoints/point')->format($invoice->getSimirewardpointsEarn()),
                'is_formated' => true,
                    )), 'subtotal');
        }
