 ...
 */
class Simi_Simirewardpoints_Block_Adminhtml_Totals_Order_Label extends Mage_Adminhtml_Block_Sales_Order_Totals_Item
{
    /**
    ...
    public function initTotals()
    {
        ...
        if ($order->getSimirewardpointsEarn()) {
            $totalsBlock->addTotal(new Varien_Object(array(
                ...
                'value' => $order->getSimirewardpointsEarn(),
                'strong'        => true,
                'is_formated'   => true,
            )), 'subtotal');
        }
        ...
        if ($order->getSimirewardpointsSpent()) {
            $totalsBlock->addTotal(new Varien_Object(array(
                ...
                'value' => $order->getSimirewardpointsSpent(),
                'strong'        => true,
                'is_formated'   => true,
            )), 'subtotal');
        }
