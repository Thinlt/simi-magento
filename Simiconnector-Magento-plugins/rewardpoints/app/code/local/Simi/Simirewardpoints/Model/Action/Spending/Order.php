 ...
 */
class Simi_Simirewardpoints_Model_Action_Spending_Order
    ...
    implements Simi_Simirewardpoints_Model_Action_Interface
{
    ...
    {
        return Mage::helper('simirewardpoints')->__('Spend points to purchase order');
    }
    ...
    {
        $order = $this->getData('action_object');
        return Mage::helper('simirewardpoints')->__('Spend points to purchase order #%s', $order->getIncrementId());
    }
