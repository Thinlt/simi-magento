...
class BlockToHtmlBefore implements ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $moduleNames = $this->_coreRegistry->registry('vnecoms_vendors_modules_use_template_from_adminhtml');
        if ($moduleNames === null) {
            ...
            $this->_coreRegistry->register('vnecoms_vendors_modules_use_template_from_adminhtml', $moduleNames);
        }
        
        $blockClassNames = $this->_coreRegistry->registry('vnecoms_vendors_blocks_use_template_from_adminhtml');
        if ($blockClassNames === null) {
            $blockClassNames = $this->_vendorHelper->getBlocksUseTemplateFromAdminhtml();
            $this->_coreRegistry->register('vnecoms_vendors_blocks_use_template_from_adminhtml', $blockClassNames);
        }
