...
class Upload extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        try {
            ...
            $result['url'] = $this->_objectManager->get('Vnecoms\PageBuilder\Model\Media\Config')
                ->getMediaUrl($result['file']);
            $result['file'] = $result['file'];
            $result['img_type'] = 'media';
            $result['img_file'] = $path.'/'.$result['file'];
        } catch (\Exception $e) {
