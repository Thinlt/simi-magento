...
class CustomOptions extends AbstractModifier
{
    ...
    protected function getCommonContainerConfig($sortOrder)
    {
        ...
        if ($this->locator->getProduct()->getStoreId()) {
            $useDefaultConfig = [
                'service' => [
                    'template' => 'Vnecoms_VendorsProduct/form/element/helper/custom-option-service',
                ]
            ];
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'additionalClasses' => 'admin__field-group-columns admin__control-group-equal',
                        'sortOrder' => $sortOrder,
                        'fieldTemplate' => 'Vnecoms_VendorsProduct/form/field',
                        'visible' => false,
                    ],
                ],
            ],
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'service' => [
                            'template' => 'Vnecoms_VendorsProduct/form/element/helper/custom-option-type-service',
                        ],
                    ],
                ],
            ],
    ...
    private function getPriceFieldConfigForSelectType(int $sortOrder)
    {
        ...
        $priceFieldConfig['arguments']['data']['config']['template'] = 'Vnecoms_VendorsProduct/form/field';
