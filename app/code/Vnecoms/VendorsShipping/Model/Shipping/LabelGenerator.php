...
class LabelGenerator
{
    ...
    /**
     * @var \Vnecoms\VendorsShipping\Model\Shipping\LabelsFactory
     */
    ...
    public function __construct(
        ...
        \Vnecoms\VendorsShipping\Model\Shipping\LabelsFactory $labelFactory,
        \Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig,
        \Magento\Sales\Model\Order\Shipment\TrackFactory $trackFactory,
        \Magento\Framework\Filesystem $filesystem,
        \Vnecoms\VendorsSales\Model\OrderFactory $order
    ) {
    ...
    public function create(\Magento\Sales\Model\Order\Shipment $shipment, RequestInterface $request)
    {
        ...
        $vendorOrder =  $this->vendorOrder->create()->load($shipment->getVendorOrderId());

        $carrier = $this->carrierFactory->create($vendorOrder->getShippingMethod(true)->getCarrierCode());
        ...
        $response = $this->labelFactory->create()->requestToShipment($shipment, $vendorOrder);
