 ...
 */
namespace Simi\VendorMapping\Model\ResourceModel\Review;
...
class Collection extends \Magento\Review\Model\ResourceModel\Review\Collection
{
    ...
    {
        $this->_init(\Simi\VendorMapping\Model\Review::class, \Simi\VendorMapping\Model\ResourceModel\Review::class);
    }
    ...
    {
        $this->addFilter('vendor', $this->getConnection()->quoteInto('main_table.vendor_id=?', $vendorId), 'string');
        return $this;
    }
