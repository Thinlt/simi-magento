    ...
    public function show()
    {
        ...
        $additionInfo = [
            'base'              => [
                ...
                'bianca_header_phone' => $this->getStoreConfig('simicustomize/pwa_header/bianca_header_phone'),
                'bianca_header_sale_title' => $this->getStoreConfig('simicustomize/pwa_header/bianca_header_sale_title'),
                'bianca_header_sale_link' => $this->getStoreConfig('simicustomize/pwa_header/bianca_header_sale_link'),
                'bianca_header_storelocator' => $this->getStoreConfig('simicustomize/pwa_header/bianca_header_storelocator'),
                'bianca_subcribe_description' => $this->getStoreConfig('simicustomize/pwa_footer_subcribe/bianca_subcribe_description'),
                'footer_logo' => $this->getStoreConfig('simicustomize/pwa_footer_subcribe/footer_logo'),
                'footer_logo_alt' => $this->getStoreConfig('simicustomize/pwa_footer_subcribe/footer_logo_alt'),
                'footer_customer_service' => $this->getStoreConfig('simicustomize/footer_customer_service/customer_service'),
                'footer_information' => $this->getStoreConfig('simicustomize/footer_customer_service/more_information'),
                'bianca_footer_phone' => $this->getStoreConfig('simicustomize/pwa_footer/bianca_footer_phone'),
                'bianca_footer_email' => $this->getStoreConfig('simicustomize/pwa_footer/bianca_footer_email'),
                'bianca_footer_facebook' => $this->getStoreConfig('simicustomize/pwa_footer/bianca_footer_facebook'),
                'bianca_footer_instagram' => $this->getStoreConfig('simicustomize/pwa_footer/bianca_footer_instagram'),
                'bianca_footer_twitter' => $this->getStoreConfig('simicustomize/pwa_footer/bianca_footer_twitter'),
                'bianca_footer_linkedin' => $this->getStoreConfig('simicustomize/pwa_footer/bianca_footer_linkedin'),
                'bianca_footer_google' => $this->getStoreConfig('simicustomize/pwa_footer/bianca_footer_google'),
                'bianca_android_app' => $this->getStoreConfig('simicustomize/footer_app/bianca_android_app'),
                'bianca_ios_app' => $this->getStoreConfig('simicustomize/footer_app/bianca_ios_app')
            ],
            'sales'             => [
