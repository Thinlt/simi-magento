    ...
    public function show()
    {
        ...
        $additionInfo = [
            'base'              => [
                ...
                'bianca_header_phone' => $this->getStoreConfig('simiconnector/pwa_header/bianca_header_phone'),
                'bianca_header_sale_title' => $this->getStoreConfig('simiconnector/pwa_header/bianca_header_sale_title'),
                'bianca_header_sale_link' => $this->getStoreConfig('simiconnector/pwa_header/bianca_header_sale_link'),
                'bianca_header_storelocator' => $this->getStoreConfig('simiconnector/pwa_header/bianca_header_storelocator'),
                'bianca_subcribe_description' => $this->getStoreConfig('simiconnector/pwa_footer_subcribe/bianca_subcribe_description'),
                'footer_logo' => $this->getStoreConfig('simiconnector/pwa_footer_subcribe/footer_logo'),
                'footer_logo_alt' => $this->getStoreConfig('simiconnector/pwa_footer_subcribe/footer_logo_alt'),
                'footer_customer_service' => $this->getStoreConfig('simiconnector/footer_customer_service/customer_service'),
                'footer_information' => $this->getStoreConfig('simiconnector/footer_customer_service/more_information'),
                'bianca_footer_phone' => $this->getStoreConfig('simiconnector/pwa_footer/bianca_footer_phone'),
                'bianca_footer_email' => $this->getStoreConfig('simiconnector/pwa_footer/bianca_footer_email'),
                'bianca_footer_facebook' => $this->getStoreConfig('simiconnector/pwa_footer/bianca_footer_facebook'),
                'bianca_footer_instagram' => $this->getStoreConfig('simiconnector/pwa_footer/bianca_footer_instagram'),
                'bianca_footer_twitter' => $this->getStoreConfig('simiconnector/pwa_footer/bianca_footer_twitter'),
                'bianca_footer_linkedin' => $this->getStoreConfig('simiconnector/pwa_footer/bianca_footer_linkedin'),
                'bianca_footer_google' => $this->getStoreConfig('simiconnector/pwa_footer/bianca_footer_google'),
                'bianca_android_app' => $this->getStoreConfig('simiconnector/footer_app/bianca_android_app'),
                'bianca_ios_app' => $this->getStoreConfig('simiconnector/footer_app/bianca_ios_app')
            ],
            'sales'             => [
