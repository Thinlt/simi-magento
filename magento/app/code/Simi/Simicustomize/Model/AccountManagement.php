...
use Simi\Simicustomize\Model\Customer as CustomerModel;
...
class AccountManagement extends \Magento\Framework\Model\AbstractModel
{
    /**
     ...
     */
    public $validationResultsDataFactory;
     ...
     */
    public $visitorCollectionFactory;
     ...
     */
    public function activateCustomer($customer, $confirmationKey)
    {
    ...
    {
        $customerDataAttributes = $this->dataProcessor->buildOutputDataArray(
            $customer,
     ...
     * @inheritdoc
     */
    public function updateCustomer($customer, $username, $password)
    {
        $customerModel = $this->updateData($customer);
     ...
     */
    public function handleUnknownTemplate($template)
    {
     ...
     * @return Backend
     */
    public function getEavValidator()
    {
     ...
     * @return void
     */
    public function destroyCustomerSessions($customerId)
    {
