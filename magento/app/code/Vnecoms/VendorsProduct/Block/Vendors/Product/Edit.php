...
namespace Vnecoms\VendorsProduct\Block\Vendors\Product;

use Vnecoms\VendorsProduct\Model\Source\Approval;

class Edit extends \Vnecoms\Vendors\Block\Vendors\Widget
{
    /**
     * @var string
     */
    protected $_template = 'Vnecoms_VendorsProduct::catalog/product/edit.phtml';
    ...
    protected function _prepareLayout()
    {
        ...
        if (!$this->getProduct()->isReadonly() && $this->getToolbar()) {
            ...
            $this->getToolbar()->addChild(
                'save-split-button',
                'Vnecoms\Vendors\Block\Vendors\Widget\Button\SplitButton',
                [
