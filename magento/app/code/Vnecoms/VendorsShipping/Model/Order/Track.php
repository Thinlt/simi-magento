...
namespace Vnecoms\VendorsShipping\Model\Order;
...
class Track extends \Magento\Sales\Model\Order\Shipment\Track
{
     ...
     * @param \Vnecoms\VendorsSales\Model\OrderFactory $order
    ...
    public function getNumberDetail()
    {
        ...
        $trackingInfo = $carrierInstance->getVendorTrackingInfo($this->getNumber(), $vendorOrder->getVendor()->getId());
        if (!$trackingInfo) {
