...
namespace Vnecoms\PdfPro\Block\Adminhtml\Sales\Order\Invoice;
...
class PrintButton extends \Magento\Backend\Block\Widget\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->helper->getConfig('pdfpro/general/admin_print_order')) {
            $this->addButton(
                'pdfpro_print',
                [
                    'label' => 'Easy PDF - '.__('Print Invoice'),
                    'class' => 'print',
    ...
    {
        return $this->getUrl('vnecoms_pdfpro/pdfpro_invoice/print',['invoice_id' => $this->getInvoiceId()]);
    }
