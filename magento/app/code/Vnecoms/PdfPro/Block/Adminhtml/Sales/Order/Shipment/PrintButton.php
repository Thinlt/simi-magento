...
namespace Vnecoms\PdfPro\Block\Adminhtml\Sales\Order\Shipment;
...
class PrintButton extends \Magento\Backend\Block\Widget\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->helper->getConfig('pdfpro/general/admin_print_order')) {
            $this->addButton(
                'pdfpro_print',
                [
                    'label' => 'Easy PDF - '.__('Print Shipment'),
                    'class' => 'print',
    ...
    {
        return $this->getUrl('vnecoms_pdfpro/pdfpro_shipment/print',['shipment_id' => $this->getRequest()->getParam('shipment_id')]);
    }
}
