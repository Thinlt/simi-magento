...
import Search from 'src/simi/core/BaseComponents/Icon/Search'
    ...
    render() {
        ...
        return (
            <div className={classes['header-search-form']}>
                <label htmlFor="harlow-search-field" className="hidden">{Identify.__('Search')}</label>
                <input 
                    type="text" 
                    id="harlow-search-field"
